...
%%
%% adjustbox for better image handling
%%
\usepackage[export]{adjustbox}


%%
%% Subfigures for multiple figures in one figure reference
%%
\usepackage{subcaption}
\captionsetup[subfigure]{list=true,labelformat=brace, position=top}
