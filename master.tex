...
%
%   auf der Grundlage einer Vorlage von Prof. Dr. Julian Reichwald
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%   2. Passen Sie alle Stellen im Dokument 
%      an, die mit @stud markiert sind
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% ohne Serifen
%1 \addtokomafont{disposition}{\sffamily}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% KAPITEL DER ARBEIT
%
% @stud: eigene Kapitel hier einfügen und bearbeiten nach dem Muster der Beispielkapitel
%
\input{chapter1}
\input{chapter2}
...
% ANHÄNGE DER ARBEIT
%
% @stud: eigene Anhänge hier einfügen und bearbeiten nach dem Muster der Beispielanhänge
%
\input{appendix1}
\input{appendix2}
