...
Au\ss erdem werden die f\"ur das Dokument ben\"otigten Pakete festgelegt, die durch \texttt{\textbackslash input\{config\}} in das Hauptdokument eingelesen wird.
gebr\"auchlich sind vor allem folgende Pakete:
...
Im vorliegenden Fall werden die Pakete in der Konfigurationsdatei \texttt{config.tex} festgelegt, die durch 
\texttt{\input\{config\}} in das Hauptdokument \texttt{master.tex} eingelesen wird.
...
unbedingt folgender Befehl vorausgehen:

\texttt{\textbackslash begin\{document\}}

Am Ende des Dokuments sollte der Befehl
\texttt{\textbackslash end\{document\}}

gesetzt werden. Alles was nach diesem Befehl steht, wird vom Compiler nicht mehr beachtet.
